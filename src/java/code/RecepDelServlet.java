 ...
 * @author MANJITHA
 */
@WebServlet(name = "RecepDelServlet", urlPatterns = {"/RecepDelServlet"})
public class RecepDelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RecepDelServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RecepDelServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    try {
        ...
        String deleteConsultantQuery = "DELETE FROM receptionist WHERE userId = ?";
        ...
        if (rowsAffectedUsers > 0 && rowsAffectedConsultant > 0) {
            ...
            String successMessage = "Receptionist Deleted Successfully";
