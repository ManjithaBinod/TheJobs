    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">All Appointments Report</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    <tbody>
                        <%        
                            ...
                            String query = "SELECT * FROM appointment "
                                    + "LEFT JOIN applicant ON applicant.aplId = appointment.aplId "
                                    + "LEFT JOIN consultant ON consultant.consId = appointment.consId "
                            ...
                            while (resultSet.next()) {
                                ...
                                String country = resultSet.getString("consultant.country");
                                String jobType = resultSet.getString("consultant.jobType");
