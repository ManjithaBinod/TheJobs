...
<%// Retrieve userId from the query parameter
    ...
    String query = "SELECT * FROM seekers WHERE skId = ?";
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Applicant : <b> <%= name%> </b></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="ApplicantEditServlet" method="POST">
                            <div class="card-body">
