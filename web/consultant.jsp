...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <a type="button" data-toggle="modal" data-target="#modal-default" href="#" class="btn btn-block bg-gradient-primary btn-md">Add Consultant</a> <br>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" role="menu" style="">
                                        <a class="dropdown-item edit-link" href="consultantEdit.jsp?userId=<%= resultSet.getInt("userId")%>" >Edit</a>
                                        <a class="dropdown-item"  href="consultantDelServlet?userId=<%= resultSet.getInt("userId")%>" onclick="return confirmWithSweetAlert(this)">Delete</a>
